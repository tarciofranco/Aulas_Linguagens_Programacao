      ...
      <?php
        if($dadosCardapio = $cardapio->Listar()){
          ...
          foreach ($dadosCardapio as $key => $value) {
            # code...
            //Ajuste no campo data Formato BR
            $data = date_create();

            $horaBR = date_format($data, 'H:i:s');
            $dataBR = date_format($data, 'd/m/y');

            $tituloData = "Data Criação: $dataBR | Hora: $horaBR";
            ?>
             <tr>
                <td><?php print $value['id']; ?></td>
                <td><?php print $value['nome']; ?></td>
                <td><?php print $value['descricao']; ?></td>
                <td title="<?php print $tituloData; ?>"><?php print $dataBR = date_format($data, 'd/m/y');  ?></td>
                <td>
